    ...
    public Respuesta getUsuario(String usuario, String clave) {
        try {
            ...
            try (Jsonb jsonb = JsonbBuilder.create()) {
                UsuarioDto usuarioDto = jsonb.fromJson(responseJson, UsuarioDto.class);

                if (usuarioDto == null) {
                    return new Respuesta(false, "Error procesando datos del usuario", "JSON inválido");
                }
            ...
            Logger.getLogger(UsuarioService.class.getName())
                    .log(Level.SEVERE, "Error obteniendo el usuario [" + usuario + "]", ex);
